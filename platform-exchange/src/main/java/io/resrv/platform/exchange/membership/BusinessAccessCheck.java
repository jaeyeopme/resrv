package io.resrv.platform.exchange.membership;
 ...
 *
 * <p>This is a decision exchange API, not a data lookup. Consumers must not infer partial facts
 * such as whether the account, business, or membership exists from a false result.
 */
